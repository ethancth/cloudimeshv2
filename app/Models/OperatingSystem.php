...
class OperatingSystem extends Model
{
    ...
    protected $fillable=['name','display_name','tenant_id','display_description','status','display_icon','display_icon_colour','is_default','update_at','updated_by','os_type','cost'];
