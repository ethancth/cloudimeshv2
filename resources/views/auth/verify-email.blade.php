  ...
  <div class="authentication-inner row">
    ...
    <div class="d-none d-lg-flex col-lg-7 p-0">
      <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
        <img src="{{ asset('assets/img/illustrations/verify-email-illustration-'.$configData['style'].'.svg') }}" alt="auth-verify-email-cover" class="img-fluid my-5 auth-illustration" data-app-light-img="illustrations/verify-email-illustration-light.svg" data-app-dark-img="illustrations/verify-email-illustration-dark.svg">
