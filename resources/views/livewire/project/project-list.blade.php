...
{{--  //<div wire:ignore.self class="modal fade" role="dialog" tabindex="-1" id="createProjectModal" data-dismiss="modal" aria-hidden="true">--}}
      <div wire:ignore.self class="modal fade" id="createProjectModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-sm-5 pb-5">
                    ...
                    <form id="createProjectForm" route="#" class="row" method="POST" accept-charset="UTF-8">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="col-12">
                            <label class="form-label" for="modalProjectName">Project Name </label>
                            <input
